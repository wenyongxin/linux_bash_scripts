...
echo "$0 -s 22 -p Efun@168 -o c -pn sea -H 172.16.5.240 172.16.5.241"
echo "手动输入密码、端口号及IP文件列表:"
echo "$0 -s 22 -p Efun@168 -o c -pn sea -f ip.txt"
...
echo "$0 -p Efun@168 -o ex -H 172.16.5.240 172.16.5.220"
echo "ESXI从ip列表中读取添加监控"
echo "$0 -p Efun@168 -o ex -f ip.txt"
echo -e "\033[49;31;5m ************************************************************************************************** \033[0m"
